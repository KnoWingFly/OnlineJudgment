		...
		<div id="content-wrap">
			...
			<div id="main">
				...
				<ul>
					...
					<li>The name of your source file must not include space. Only the extension does.</li>
					...
					<li>Any program that takes longer than 3 seconds to execute will be flagged 'Time Limit'</li>
					<li><strong>WARNING</strong> : Compiler command for c++ user will be "g++ source_file -o output 2> /dev/null" </li>
					<li><strong>WARNING</strong> : Compiler command for c user will be "gcc source_file -o output 2> /dev/null" </li>
					<li><strong>WARNING</strong> : Compiler version for both C and C++ user is 4.4.5, and the server OS will be debian (UNIX based OS) </li>
...
<li>This may take a while when the server is loaded, so please be patient.</li>
				...
				<ul>
					...
					<li><strong>Runtime Error</strong> : There is a segmentation fault, or your program is crashing during the test run (div by zero, etc)</li>
